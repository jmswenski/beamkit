...
It also computes exact deterministic plan and prescription fingerprints for release/write-up evidence. Use fingerprints for snapshot identity, and use `PlanChangeDetector` for tolerant, human-readable drift explanations.
